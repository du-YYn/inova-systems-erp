      ...
      {showInvoiceModal && (
        <div className="fixed inset-0 bg-black/40 backdrop-blur-sm flex items-center justify-center z-50 animate-fade-in">
          ...
          <div className="bg-white dark:bg-gray-800 rounded-2xl p-6 w-full max-w-2xl mx-4 max-h-[90vh] overflow-y-auto shadow-modal animate-modal-in">
            <div className="flex items-center justify-between mb-6">
              <h2 className="text-xl font-semibold text-gray-900 dark:text-gray-100">{editingInvoice ? 'Editar Despesa' : 'Nova Despesa Variável'}</h2>
            ...
            <form onSubmit={handleSaveInvoice} className="space-y-4">
              ...
              {/* Cliente removido — despesas variáveis não têm relação com cliente */}

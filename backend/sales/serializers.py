...
def _sync_proposal_services(proposal, service_ids):
    """Sincroniza ProposalService preservando ordem enviada."""
    ...
    for order, sid in enumerate(service_ids):
        try:
            ...
            # Serviço inexistente — ignora para não quebrar a proposta
            continue


def _sync_contract_services(contract, service_ids):
    """Sincroniza ContractService preservando ordem enviada."""
